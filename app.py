...
DEFAULT_PREFERENCES = """ Remote digital marketing roles, including Digital Marketing Specialist, Performance Marketing Specialist, 
Social Media Marketing Executive, E-commerce Marketing Specialist, Creative/Content Marketing Specialist, 
Marketing Executive, Growth Marketing Associate, Brand Marketing Specialist, 
Ad Operations Specialist, and Marketing Coordinator."""

AGENT_INSTRUCTIONS = """
You are JobFinder AI, a focused job-search agent.
...
async def run_jobfinder(cv_file: str, preferences: str):
    logs = []
    ...
    try:
        ...
        result = Runner.run_streamed(
            ...
            run_config=RunConfig(workflow_name="JobFinder AI Kimi Search", tracing_disabled=True),
        )
...
with gr.Blocks(title="Jobfinder AI") as demo:
    gr.Markdown(
        """
# JobFinder AI
...
"""
    ...
    run_button = gr.Button("Generate Jobfinder Report", variant="primary", elem_id="run-button")
