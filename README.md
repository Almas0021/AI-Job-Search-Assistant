...
An AI powered job search assistant that helps users find relevant job opportunities and evaluate them based on their CV, skills, experience, and job preferences.
...
Moonshot AI API – API used to access the Kimi model
Olostep API – Used for web search and webpage scraping
